(function() {
  ...
  function tool2() {
    (async () => {
      ...
      const o = [{
        ...
        content: "🎊 Tak cần undian, mọi người dùng đều đủ điều kiện nhận giải thưởng hàng ngày!"
      }];
  ...
  (function() {
    ...
    if (document.getElementById('myBookmarkletMenu')) {
      const menu = document.getElementById('myBookmarkletMenu');
    ...
    toggleBtn.textContent = 'Ẩn/Hiện Menu';
